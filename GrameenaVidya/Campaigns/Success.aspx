<%@ Page Title="" Language="C#" MasterPageFile="~/Master/InsideMaster.master" AutoEventWireup="true" CodeBehind="Success.aspx.cs" Inherits="GrameenaVidya.Campaigns.Success" %>
        ...
        <div class="col-lg-6 col-lg-offset-3 panel panel-default">
            ...
            <table class="table table-condensed">
                ...
                <tr>
                    ...
                    <td><b><asp:Label ID="lblAddress" runat="server"></asp:Label></b></td>
                </tr>
