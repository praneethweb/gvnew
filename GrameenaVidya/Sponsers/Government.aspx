<%@ Page Title="" Language="C#" MasterPageFile="~/Master/OutSideMaster.master" AutoEventWireup="true" CodeBehind="Government.aspx.cs" Inherits="GVSchools.Sponsers.Government" %>
 ...
 <uc3:SocialMedia ID="SocialMedia1" runat="server" />
  ...
  <div class="causes">
    <div class="container">
      ...
      <%--   <h1>Individual
         <a href="../Programs/donationlist.aspx"  class="btn btn-yellow btn-right">Existing Sponsors</a>
         </h1>    --%>
           <ul class="nav nav-tabs">
                                    <li ><a href="#Individual" data-toggle="tab" style="font-size: 15px;">
                                    Individual</a></li>
                                <li class="active"><a href="#Government" data-toggle="tab" style="font-size: 15px;">Government</a></li>
                                <li><a href="#Corparate" data-toggle="tab" style="font-size: 15px;">Corporate</a></li>
                                </ul>
          ...
          <div class="tab-content product-tab">
                                ...
                                <p>
                                    ...
                                    <div class="tab-pane active fade in" id="Government">
                                     <p>
                                ...
                                with Governments on a PPP (Public – Private Partnership) basis.</p>
                                    ...
                                    <div class="tab-pane fade" id="Corparate">
                                       <p>
