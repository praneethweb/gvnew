<%@ Page Title="" Language="C#" MasterPageFile="~/Master/OutSideMaster.master" AutoEventWireup="true" CodeBehind="Individual.aspx.cs" Inherits="GVSchools.Sponsers.Individual" %>
    ...
    <div class="container">
     ...
     <h1 class="page-heading">Type of Sponsers
           ...
           <ul class="nav nav-tabs">
                                    <li class="active"><a href="#Individual" data-toggle="tab" style="font-size: 15px;">
                                    Individual</a></li>
          ...
          <div class="tab-content product-tab">
                                    <div class="tab-pane active fade in" id="Individual">
                                       <p>
