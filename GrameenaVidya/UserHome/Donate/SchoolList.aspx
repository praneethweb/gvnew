<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SchoolList.aspx.cs" Inherits="GrameenaVidya.UserHome.Donate.SchoolList" %>
...
<script type = "text/javascript">
    ...
    function Call(ID) {
        ...
        var myPopup = window.open("../../Programs/SchoolsDetails.aspx?ID=" + ID.toString(), "", "directories=no,height=650,width=1250,menubar=no,resizable=no,scrollbars=no,status=no,titlebar=no,top=0,location=no,scrollbars=yes");
